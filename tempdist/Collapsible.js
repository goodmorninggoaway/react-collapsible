...
var Collapsible = _react2.default.createClass({
  ...
  render: function render() {
    ...
    var triggerClassName = this.props.classParentString + "__trigger" + ' ' + openClass + ' ' + this.state.isClosed ? this.props.triggerClassName : this.prop.triggerOpenedClassName;
